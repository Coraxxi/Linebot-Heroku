            ...
            foods.randomSelectFoods().then(data => {  
                if (data == -1){
                    ...
                    data.forEach(item => {
                        msg.push({
                            "type": "image",
                            "originalContentUrl": "https://tomlin-app-1.herokuapp.com/imgs/" + item.photo,
                            "previewImageUrl": "https://tomlin-app-1.herokuapp.com/imgs/" + item.photo
                        });                        
                    });

                    event.reply(msg);  //回傳食物圖片
                }  
            })  
        }
    );
